...
- (void)loadView
{
    ...
    NSStackView* stack = make_form(@[
        ...
        make_row(@"Musixmatch token:", mmField),
    ]);
...
- (void)onMusixmatch:(NSTextField*)sender
{
    const char* str = sender.stringValue.UTF8String;
    cfg_search_musixmatch_token.set(str ? str : "");
}
...
public:
    ...
    const char* get_name() override { return "Upload"; }
